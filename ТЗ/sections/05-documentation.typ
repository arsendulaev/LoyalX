...
#list2[
1. Документация должна содержать адреса развернутых смарт-контрактов в сети Testnet/Mainnet.
2. Пояснительная записка должна включать схему взаимодействия контрактов (Sequence Diagram).
]